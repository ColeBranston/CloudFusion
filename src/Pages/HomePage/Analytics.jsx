        ...
        <div className='w-full bg-gray-100 py-16 px-4'>
            <div className = 'max-w-[1240px] mx-auto grid md:grid-cols-2'>
                ...
                <div className='flex flex-col justify-center'>
                    <p className='text-[#bfb749] font-bold'> DATA ANALYTICS DASHBOARD</p>
                    ...
                    <button className='bg-black text-[#bfb749] w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3'>
                        <p> Get Started </p>
                    </button>
                </div>
