...
const Card =({person, reveal}) => {
    ...
    return (
        <div onClick={() => reveal(person)} className="person bg-gray-300 lg:w-[32.5%] lg:h-1/3 md:w-[60%] md:h-1/2 w-[70%] h-1/3 mx-auto m-[1.5rem] md:m-[1.5rem] lg:m-[1.5rem]" style={{animation: `appear ${person.id}s`}}>
